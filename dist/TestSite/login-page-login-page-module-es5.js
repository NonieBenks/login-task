  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["login-page-login-page-module"], {
    ...
    function srcAppLoginPageContainerLoginPageComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var LoginPageComponent = /*#__PURE__*/function () {
        function LoginPageComponent(accountService, router, translate) {
          ...
          translate.setDefaultLang("fr"); //translate.use("fr");
        }
      ...
      LoginPageComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 25,
        vars: 21,
        consts: [[1, "login"], [1, "login-title"], [1, "login-form"], ["appearance", "outline", 1, "form-field"], ["matInput", "", "placeholder", "pat@example.com", 1, "input-field", 3, "formControl"], [4, "ngIf"], ["matInput", "", 1, "input-field", 3, "type", "formControl"], ["mat-icon-button", "", "matSuffix", "", 3, "click"], [1, "wrong-value"], ["mat-flat-button", "", "routerLink", "/home", 1, "login-btn", 3, "click"]],
        template: function LoginPageComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function LoginPageComponent_Template_button_click_22_listener() {
              return ctx.accountService.login(ctx.login.value, ctx.password.value);
            });
