...
HomePageGuard.ɵfac = function HomePageGuard_Factory(t) { return new (t || HomePageGuard)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_shared_services_account_service__WEBPACK_IMPORTED_MODULE_1__["AccountService"])); };
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](HomePageGuard, [{
    ...
    }], function () { return [{ type: _shared_services_account_service__WEBPACK_IMPORTED_MODULE_1__["AccountService"] }]; }, null); })();
...
class AccountService {
    ...
    setAppState(userStatus) {
        this.loggedIn = userStatus;
        const jsonLoggedIn = JSON.stringify(this.loggedIn);
...
class ToolbarComponent {
    constructor(router, accountService, translate, http) {
        this.router = router;
        this.accountService = accountService;
...
ToolbarComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ToolbarComponent, selectors: [["app-toolbar"]], decls: 10, vars: 5, consts: [["mat-icon-button", "", "class", "home-icon", "aria-label", "Example icon-button with menu icon", "routerLink", "/home", 4, "ngIf"], ["mat-icon-button", "", "aria-label", "Example icon-button with menu icon", "routerLink", "/login", 4, "ngIf"], ["mat-icon-button", "", "aria-label", "Example icon-button with heart icon", 3, "click", 4, "ngIf"], ["mat-icon-button", "", 3, "matMenuTriggerFor"], [1, "lang-menu"], ["menu", "matMenu"], ["mat-menu-item", "", "class", "lang-btn", 3, "click", 4, "ngFor", "ngForOf"], ["mat-icon-button", "", "aria-label", "Example icon-button with menu icon", "routerLink", "/home", 1, "home-icon"], [1, "example-spacer"], ["mat-icon-button", "", "aria-label", "Example icon-button with menu icon", "routerLink", "/login"], ["mat-icon-button", "", "aria-label", "Example icon-button with heart icon", 3, "click"], ["mat-menu-item", "", 1, "lang-btn", 3, "click"]], template: function ToolbarComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", ctx.accountService.getAppState());
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", ctx.accountService.getAppState());
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", ctx.accountService.getAppState());
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ToolbarComponent, [{
    ...
    }], function () { return [{ type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"] }, { type: src_app_shared_services_account_service__WEBPACK_IMPORTED_MODULE_2__["AccountService"] }, { type: _ngx_translate_core__WEBPACK_IMPORTED_MODULE_3__["TranslateService"] }, { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"] }]; }, null); })();
